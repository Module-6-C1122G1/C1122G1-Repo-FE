    ...
    const handlePrint = useReactToPrint({
        ...
        onAfterPrint: () => {
            const confirmPrintTicket = async() => {
                try {
                    await ticketService.confirmPrintTicket(valueTicket.idTicket)
                                            ...
                                            <Form>
                                                <table>
                                                        ...
                                                        <td>
                                                            {
                                                                ticketDetail?.ticketSet
                                                                    .filter(element => element.seat.seat.idStatusSeat === 1 && element.delete === false)
                                                                    .map((element, index) => (
                                                                        <div className="mb-3" key={index}>
                                                                            ...
                                                                            <label class="form-check-label ms-2" for={element.seat.idSeat}>
                                                                                ...
                                                                                {element.seat.typeSeat.nameTypeSeat === 'VIP' ? ' (Ghế VIP)' : ' (Ghế thường)'}
                                                                                <span className="ms-3" style={{ color: "lightcoral" }}>
                                                    ...
                                                    <tr className="" style={{ height: 39 }}>
                                                        ...
                                                        <td><span style={{ color: "lightcoral" }}>
                                                                {ticketDetail?.ticketSet
                                                                    .filter(element => element.seat.seat.idStatusSeat === 1 && element.delete === false)
                                                                    .map((element, index) => (
