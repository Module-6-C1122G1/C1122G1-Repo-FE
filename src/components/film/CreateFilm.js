                ...
                <Formik
                    ...
                    validationSchema={Yup.object({
                        ...
                        timeFilm: Yup.number()
                            ...
                            .min(30, "Thời lượng phim không được nhỏ hơn 30 phút")
                            .max(200, "Thời lượng phim không được lớn hơn 200 phút"),
                        ...
                        normalSeatPrice: Yup.number()
                            ...
                            .min(10000, "Giá ghế thường không được nhỏ hơn 10.000 VNĐ")
                            .max(1000000000, "Giá ghế thường không được quá 1.000.000.000 VNĐ"),
                        vipSeatPrice: Yup.number()
                            .required("Nhập giá ghế vip")
                            .min(10000, "Giá ghế vip không được nhỏ hơn 10.000 VNĐ")
                            .max(1000000000, "Giá ghế vip không được quá 1.000.000.000 VNĐ"),
