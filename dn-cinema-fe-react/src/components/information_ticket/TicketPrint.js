                        ...
                        <div className="detail-rating p-3">
                            ...
                            <table>
                                ...
                                <tr style={{height: 39}}>
                                    ...
                                    <td style={{fontFamily: "Roboto"}}>{props.ticketDetail.ticketSet[0].seat.showTime.film.dateStartFilm}</td>
                                </tr>
                                <tr style={{height: 39}}>
                                ...
                                <tr style={{height: 39}}>
                                    ...
                                    <td>{props.ticketDetail.ticketSet[0].seat.nameSeat}</td>
                                </tr>
                                <tr className="" style={{height: 39}}>
                                    <th className="text-secondary">Giá:</th>
                                    <td>{props.ticketDetail.ticketSet[0].priceAfterDiscount}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
